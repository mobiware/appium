...
=======
androidController.toggleData = function(ocb) {
=======
androidController.toggleSetting = function(setting, ocb) {
      ...
      this.adb.getFocusedPackageAndActivity(function(err, foundPackage,
        ...
        this.adb.shell(cmd, function(err) {
          if(err) {
            ...
            this.adb.waitForNotActivity(foundPackage, foundActivity, 3000, cb);
          }
        }.bind(this));
      }.bind(this));
    }.bind(this),
    function(cb) {
      var cmd = 'input keyevent 20';
      this.adb.shell(cmd, cb);
    }.bind(this),
    function(cb) {
      setTimeout(function() {
        if(!(typeof this.uiautomatorRestartOnExit === 'undefined')) {
          this.uiautomatorRestartOnExit = true;
        }
        var cmd = 'input keyevent 23';
        this.adb.shell(cmd, cb);
      }.bind(this), 3000);
    }.bind(this),
    function(cb) {
...
androidController.toggleFlightMode = function(ocb) {
